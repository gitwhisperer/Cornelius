...
export const AppShell = ({ children }: { children: React.ReactNode }) => {
  ...
  // Mobile: Full viewport with proper overflow handling
  if (!isDesktop) {
    return (
      <div
        className="fixed inset-0 bg-white dark:bg-[#0a0a0a] flex flex-col"
        style={{
          height: '100dvh',
  ...
  // Desktop: Phone simulator with resizable container
  return (
